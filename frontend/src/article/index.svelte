...
<div class="content">
  ...
  <Link url="https://wf-calendar.miaowm5.com/event-{server.flag}.ics" />
...
<div class="content">
  {#if server.flag === 'jp'}
    <Link url="https://twitter.com/world_flipper" prefix="官方推特：" />
    <Link url="https://worldflipper.jp/news/" prefix="日服官网：" />
  {/if}
  {#if server.flag === 'ch'}
